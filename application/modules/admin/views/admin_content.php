                     ...
                     <div class="table-toolbar">
                       ...
                       <!-- <a class="left adminadd" href="<?php echo base_url(). 'index.php/admin/adduser'?>">Add <?php echo $admin_subtitle?></a> -->
                         ...
                         <ul class="dropdown-menu">
                           ...
                           <li><a href="<?php echo base_url(). 'admin/createusersview/active/pdf'?>">Export to PDF</a></li>
                           <li><a href="<?php echo base_url(). 'admin/createusersview/active/excel'?>">Export to Excel</a></li>
                         </ul>
                       </div>
                     </div>
