...
<div class="col s12 m4">
                 ...
                 <img class="materialboxed" height="250" width="250" src="<?php echo $data['photopath']; ?>">
          ...
          <div class="card small hoverable">
             ...
             <div class="card-content">
               <span class="card-title activator grey-text text-darken-4">Photo-ID: <?php echo $data['photoid']; ?> 
               <!-- Product For Product-ID: <?php echo $data['userid']; ?><i class="material-icons right">more_vert</i> -->
               </span>
             </div>
...
<div class="col s12 m4">
                 ...
                 <!-- <img class="materialboxed" height="250" width="250" src="<?php echo base_url(). 'assets/images/mareka.jpg'?>"> -->
                 <img class="materialboxed" height="250" width="250" class="activator" src="<?php echo $data['photopath']; ?>">
