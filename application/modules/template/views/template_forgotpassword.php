    ...
    <div class="row log-box center">
        <div class="col s12 m12 log-panel">
            ...
            <div class="login-cred container">
                <div class="row ">
                  <form role="form" enctype="multipart/form-data" method="POST" action="<?php echo base_url() . 'admin/request_password'?>" class="form-horizontal">
                    <div class="row">
                      <div class="input-field col s12 m12">
                        <i class="material-icons prefix">account_circle</i>
                        <input name="useremail" id="useremail" required type="email" class="validate">
                    ...
                    <div class="row">
                      <div class="input-field col s12 m12 center">
                         <button class="btn waves-effect waves-light" type="submit" name="action">Send Request
                  ...
                  <a href="<?php echo base_url(). 'admin'?>" class="btn waves-effect waves-light btn-small"><i class="material-icons left">skip_previous</i>Back to Login Page</a>
                       ...
                       <?php
                        ...
                        <?php } elseif (!(isset($logmessage))) { ?>
                            <div class="card-panel black-text white">
                              <?php echo "Enter your email to send a request"; ?>
                            </div>
