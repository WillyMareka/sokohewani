    ...
    <div class="row log-box center">
        <div class="col s12 m12 log-panel">
            ...
            <div class="login-cred container">
                <div class="row ">
                  <form role="form" enctype="multipart/form-data" method="POST" action="<?php echo base_url() . 'admin/update_password'?>" class="form-horizontal">
                    <div class="row">

                    
                    <input name="email_hash" type="hidden"  value="<?php echo $email_hash; ?>" class="span6 m-wrap form-control "/>
                    
                    
                    <input name="email_code" type="hidden"  value="<?php echo $email_code; ?>" class="span6 m-wrap form-control "/>
                     ...
                     <div class="row">
                      <div class="input-field col s12 m12">
                        ...
                        <input name="upemail" value="<?php echo (isset($email)) ? $email : ''; ?>" id="upemail" required type="email" class="validate">
                     ...
                     <div class="input-field col s12 m12 center">
                        ...
                        <input id="changepass" name="changepass" required type="password" class="validate">
                    ...
                    <div class="row">
                      <div class="input-field col s12 m12 center">
                        <i class="material-icons prefix">vpn_key</i>
                        <input id="changepass2" name="changepass2" required type="password" class="validate">
