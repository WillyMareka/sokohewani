...
class Googlemaps {
	...
	var $center						= "place.geometry.location";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
	...
	function add_circle($params = array())
	{
		...
		$circle['center'] = 'myLatlng';									// The center position (latitude/longitude coordinate OR addresse) at which the circle will appear
